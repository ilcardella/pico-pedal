...
GFX::GFX(uint16_t const DevAddr, uint8_t const width, uint8_t const height,
         i2c_inst_t *i2c)
    : SSD1306(DevAddr, width, height, i2c){};
...
void GFX::drawProgressBar(int x, int y, uint16_t w, uint16_t h, uint8_t progress,
                          colors color)
{
